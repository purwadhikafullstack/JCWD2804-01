      ...
      <div className="flex gap-4">
        <div className="flex items-center">
          <DatePicker
            ...
            className="flex items-center bg-gray-200 text-black border-2 rounded p-2 w-[200px] h-[50px] focus:outline-none"
        ...
        <div className="flex items-center">
          <DatePicker
            ...
            className="bg-gray-200 text-black border-2 rounded p-2 w-[200px] h-[50px] focus:outline-none"
